...
/*   Updated: 2024/12/16 10:20:15 by pdessant         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (n < 16)
		ft_putchar_fd("0123456789abcdef"[n], fd, ret);
	else if (n >= 16)
	{
...
{
	if (p < 16)
		ft_putchar_fd("0123456789abcdef"[p], fd, ret);
	else if (p >= 16)
	{
...
{
	if (p == 0)
		ft_putstr_fd("(nil)", fd, ret);
	else
	{
		ft_putstr_fd("0x", fd, ret);
